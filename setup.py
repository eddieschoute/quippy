#!/usr/bin/env python
"""A parser for the ASCII files produced by Quipper.
Project page: https://github.com/eddieschoute/quippy
...
setup(
    ...
    url='https://github.com/eddieschoute/quippy',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Eddie Schoute',  # Optional
    ...
    data_files=[('.', ['LICENSE','NOTICE'])],  # Optional
